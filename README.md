...
│   ├── client_summary_report_template.md
│   └── product_roadmap.md
├── reports/
...
- [x] Location Finder and Market Gaps — the two remaining minimum-scope modules
- [x] Documentation set — [final report](docs/final_report.md), refresh SOP, consultant
      guide, client report template, roadmap
- [ ] Household composition and age from ACS, to model demand beyond income alone
- [ ] Validate the scores against restaurants opened since 2024
- [ ] Per-user data permissions in the database
